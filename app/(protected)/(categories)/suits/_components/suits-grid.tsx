...
interface SuitsGridProps {
  session: Session | null;
}

export const SuitsGrid = ({ session }: SuitsGridProps) => {
  ...
  const {
    ...
    queryKey: ["category"],
    queryFn: () => getCategory("a4d76a7b-7d22-498d-8046-1c46441e5c91"),
  });
  ...
  const {
    ...
    queryFn: () =>
      getProducts({
        categoryId: "a4d76a7b-7d22-498d-8046-1c46441e5c91",
        isArchived: false,
      }),
  });
